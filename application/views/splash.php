...
<head>
    ...
    <meta property="og:title" content="ECFS 2015 - Edinburgh Charity Fashion Show">
    <meta property="og:description" content="Edinburgh Charity Fashion Show (ECFS) 2015">
...
<div class="container">
    <div id="splash" class="text-center center-all">
        <p><a href="/welcome"><img class=" img-responsive" title="Click to enter" alt="Click to enter" src="/assets/img/ecfs-logo.png"></a></p>
    </div>
</div>
</body>
</html>